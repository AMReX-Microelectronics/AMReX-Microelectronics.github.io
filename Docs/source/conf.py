...
project = 'MicroEleX'
copyright = '2017-2024, MicroEleX collaboration'
author = 'MicroElex collaboration'
...
htmlhelp_basename = 'MicroEleXdoc'
...
latex_documents = [
    (master_doc, 'MicroEleX.tex', 'MicroEleX Documentation',
     'MicroEleX collaboration', 'manual'),
]
...
man_pages = [
    (master_doc, 'artemis', 'MicroEleX Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MicroEleX', 'MicroEleX Documentation',
     author, 'MicroEleX', 'MicroEleX is an Adaptive mesh Refinement Time-domain ElectrodynaMIcs Solver for modeling and studying the performance of microelectronics devices.',
     'Miscellaneous'),
]
...
breathe_default_project = "MicroEleX"
